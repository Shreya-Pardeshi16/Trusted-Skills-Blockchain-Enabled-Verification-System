...
public List<Student> getAlumniReport(String userid1){
		...
		rs=st.executeQuery("select * from userdetails where usertype='alumni' and userid='"+userid1+"'");
		Student vs;
	...
	public List<Freelancer> getPendingRegistrations() {
	    List<Freelancer> pendingStudents = new ArrayList<>();
	    GetConnection gc = new GetConnection();
	    Connection con;
	    ResultSet rs;
	    ...
	    try {
	        con = gc.getConnection();
	        String query = "SELECT * FROM userdetails WHERE  usertype='freelancer' and userstatus = 'pending'";
	        PreparedStatement pst = con.prepareStatement(query);
	        rs = pst.executeQuery();

	        while (rs.next()) {
	        	Freelancer student = new Freelancer();
	...
	public List<Freelancer> getAlumniReport() {
	    List<Freelancer> pendingStudents = new ArrayList<>();
	    GetConnection gc = new GetConnection();
	    Connection con;
	    ResultSet rs;
	    ...
	    try {
	        con = gc.getConnection();
	        String query = "SELECT * FROM userdetails WHERE  usertype='freelancer' and userstatus = 'active'";
	        PreparedStatement pst = con.prepareStatement(query);
	        rs = pst.executeQuery();
