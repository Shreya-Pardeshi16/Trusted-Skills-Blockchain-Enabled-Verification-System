	...
	public  String updateStudentStatus() {
		...
		try {
			...
			if(x>0) {
				...
				pst=con.prepareStatement("update userdetails SET userstatus='active' where userid=?");
				pst.setString(1, userid);
				
				x=pst.executeUpdate();
				try {
					GMailer gmail=new GMailer(path);
					String msg="<b>Dear "+usernm+"</b>,<br/><br/> your account has been approved by administrator. You can login into the system now.. <br/><br/><br/> <b>Trusted Skills</b>";
