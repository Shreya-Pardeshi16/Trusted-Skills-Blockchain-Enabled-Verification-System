...
public List<Student> getAlumniReport(String userid1){
	...
	public List<WorkingProfessionals> getPendingRegistrations() {
	    ...
	    try {
	        con = gc.getConnection();
	        String query = "SELECT * FROM userdetails WHERE  usertype='WorkingProfessional' and userstatus = 'pending'";
	...
	public List<WorkingProfessionals> getAlumniReport() {
	    ...
	    try {
	        con = gc.getConnection();
	        String query = "SELECT * FROM userdetails WHERE  usertype='WorkingProfessional' and userstatus = 'active'";
	        PreparedStatement pst = con.prepareStatement(query);
	        rs = pst.executeQuery();
