...
else if(request.getAttribute("activity").toString().trim().equals("InstReg"))
{
	%>
	Institute Registeration Done Successfully...
...
else if(request.getAttribute("activity").toString().trim().equals("RegEmp"))
{
	%>
	Employer Registration Done Successfully...
