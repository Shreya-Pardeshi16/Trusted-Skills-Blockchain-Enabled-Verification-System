                           ...
                           <div class="nav-item dropdown">
      						...
      						<div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded"> 
                             	...
                             	<div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Freelancers</a>
                                <div class="dropdown-menu rounded"> 
                                    <a href="approvestudentlist_free" class="dropdown-item">Pending Registration</a>
                                    <a href="viewFreelancers" class="dropdown-item"> Report</a>
                                   
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Institutes</a>
                                <div class="dropdown-menu rounded"> 
                                    <a href="RegInstitute" class="dropdown-item">Register New Institute</a>
                                    <a href="viewInstitutes" class="dropdown-item"> Report</a>
                                   
                                </div>
                            </div>
                             <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Employers</a>
                                <div class="dropdown-menu rounded"> 
                                    <a href="RegEmployer" class="dropdown-item">Register Employer</a>
                                    <a href="viewEmployers" class="dropdown-item"> Report</a>
